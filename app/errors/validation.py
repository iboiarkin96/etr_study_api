"""Mapping of Pydantic validation errors to stable API error codes."""
...
DEFAULT_CREATE_USER_VALIDATION_RULE = ValidationCodeRule(
    code="099",
    key="USR_CREATE_VALIDATION_ERROR",
