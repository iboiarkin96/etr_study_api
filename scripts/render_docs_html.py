...
TARGET_DIRS = ("services/portal/adr", "services/portal/developer", "services/portal/runbooks")
...
def main() -> None:
    """Scan ``services/portal/adr``, ``services/portal/developer``, ``services/portal/runbooks`` for ``*.md`` and write ``*.html``.
