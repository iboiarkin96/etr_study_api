...
_DIR_COMMENTS: dict[str, str] = {
    ...
    "services/portal/internal/uml/include": "Shared PlantUML skin (merged at Kroki render)",
    "services/portal/internal/uml/sequences": "Sequence diagram sources",
    "services/portal/internal/uml/rendered": "Rendered SVGs",
