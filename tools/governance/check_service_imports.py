...
Allowed:
  • imports inside the same service (e.g. ``app.core.config`` from
    :file:`tools/api/openapi_governance.py``)
...
(e.g. :file:`tools/docs/sync_docs.py` extracts the FastAPI route
...
Run::
    ...
    .venv/bin/python tools/governance/check_service_imports.py
