...
def scan_page(
    ...
    for m in HREF_RE.finditer(text):
        ...
        # fresh checkout or CI runner. Validation of these URLs is delegated to
        # `tools/docs/check_storybook_refs.py`, which reads the built index and
        # verifies both the story id and the relative-path depth. Skipping here
        # keeps the ADR/RFC link checker green while the story linter owns the
        # class of URL end-to-end.
        if "storybook-static/" in path_part:
            continue
