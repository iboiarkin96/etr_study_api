...
Usage:
  ...
  python tools/docs/regenerate_docs.py --check
  python tools/docs/regenerate_docs.py --watch
  python tools/docs/regenerate_docs.py --bootstrap-manifest   # offline: fill input-hashes.json
  python tools/docs/regenerate_docs.py --force                 # ignore cache, re-render all
"""
